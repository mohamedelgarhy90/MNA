...
WebUI.click(findTestObject('Object Repository/Page_Sign In/svg_Sign In_injected-svg'))
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Project Management/path'))

WebUI.click(findTestObject('Object Repository/Page_Project Management/svg__MuiSvgIcon-root MuiChip-deleteIcon'))

WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/Page_Project Management/input_Supported Languages_localization'), 
    '', 0)

WebUI.rightClick(findTestObject('Object Repository/Page_Project Management/input_Supported Languages_localization'))
...
WebUI.click(findTestObject('Object Repository/Page_Project Management/svg__MuiSvgIcon-root MuiSvgIcon-fontSizeSmall'))
