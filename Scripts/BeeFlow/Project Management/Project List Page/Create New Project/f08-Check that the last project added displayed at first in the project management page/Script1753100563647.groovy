...
WebUI.setText(findTestObject('Object Repository/Page_Project Management/input_Project Name_name'), 'c')

WebUI.setText(findTestObject('Object Repository/Page_Project Management/input_Project Code_code'), 'c')

WebUI.setText(findTestObject('Object Repository/Page_Project Management/textarea_Project Description_description'), 'd')

WebUI.setText(findTestObject('Object Repository/Page_Project Management/textarea_d'), 'de')

WebUI.setText(findTestObject('Object Repository/Page_Project Management/textarea_de'), 'des')
...
WebUI.click(findTestObject('Object Repository/Page_Project Management/li_English'))

WebUI.click(findTestObject('Object Repository/Page_Project Management/button_Create'))

WebUI.click(findTestObject('Object Repository/Page_Basic Information/a_Projects Management'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Project Management/div_c'), 'c')
