...
WebUI.click(findTestObject('Object Repository/Page_Project Management/i_c_fas fa-ellipsis-h'))

WebUI.click(findTestObject('Object Repository/Page_Project Management/div_Delete Project'))

WebUI.click(findTestObject('Object Repository/Page_Project Management/button_Yes'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Project Management/div_Project has been deleted successfully'))
