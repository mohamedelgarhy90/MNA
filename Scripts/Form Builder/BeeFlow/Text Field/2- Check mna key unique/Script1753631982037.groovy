...
WebUI.click(findTestObject('Object Repository/Page_Task Management/button_Mna Key_penta-editable-textbox-button'))

WebUI.doubleClick(findTestObject('Object Repository/Page_Task Management/input_Mna Key_mnaKey'))

WebUI.setText(findTestObject('Object Repository/Page_Task Management/input_Mna Key_mnaKey'), 'unique')

WebUI.click(findTestObject('Object Repository/Page_Task Management/path_Mna Key_Mask'))

WebUI.click(findTestObject('Object Repository/Page_Task Management/button_Submit'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Task Management/p_A field with this MNA key already exists._29583e'))

WebUI.click(findTestObject('Object Repository/Page_Task Management/button_Close'))
