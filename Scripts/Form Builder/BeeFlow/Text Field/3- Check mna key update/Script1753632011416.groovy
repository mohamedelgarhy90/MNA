...
WebUI.click(findTestObject('Object Repository/Page_Task Management/svg_1'))

WebUI.click(findTestObject('Object Repository/Page_Task Management/button_Confirm'))

WebUI.setText(findTestObject('Object Repository/Page_Task Management/input_Mna Key_mnaKey'), 'text33')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Task Management/span_Text33 - Text'), 'Text33 - Text')
...
WebUI.setText(findTestObject('Object Repository/Page_Task Management/input_Mna Key_mnaKey'), 'text3')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Task Management/span_Text3 - Text'), 'Text3 - Text')
