...
WebUI.click(findTestObject('Object Repository/Page_Task Management/div_Form Designer'))

WebUI.click(findTestObject('Object Repository/Page_Task Management/svg'))

WebUI.setText(findTestObject('Object Repository/Page_Task Management/input_Label_label'), 'text is larger than fifty characters to check the validation')

WebUI.click(findTestObject('Object Repository/Page_Task Management/button_Submit'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Task Management/div_Shouldnt exceed 50 char'))
