...
WebUI.setText(findTestObject('Object Repository/Date Time/Page_Plugin Preview/input_Label_label'), 'test')

WebUI.click(findTestObject('Object Repository/Date Time/Page_Plugin Preview/button_Submit'))

WebUI.verifyElementText(findTestObject('Object Repository/Date Time/Page_Plugin Preview/label_test'), 'test')

WebUI.click(findTestObject('Object Repository/Date Time/Page_Plugin Preview/button_Save'))

WebUI.waitForElementPresent(findTestObject('Object Repository/Date Time/Page_Plugin Preview/div_Plugin updated successfully'), 
    0)
